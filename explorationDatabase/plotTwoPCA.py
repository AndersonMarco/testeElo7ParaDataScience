...
x=[[],[],[],[],[],[],[],[],[],[]]
y=[[],[],[],[],[],[],[],[],[],[]]
sql = "SELECT valuesdata,rating FROM elo7_datascience.genome_scores_pca_at_one_line  g1 inner join ratings r1 on g1.idmovie= r1.idmovie inner join relation_movie_genre rg  on rg.idmovie=g1.idmovie where rg.idgenre=15  limit 500000"
cursor = mydb.cursor()
